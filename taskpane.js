...
Office.onReady((info) => {
  ...
  // Associate action for shortcut trigger
  ...
  // Also listen for Ctrl+Shift+M directly inside the pane as a fallback
  // This fires when focus is inside the task pane iframe
...
function handleGlobalKey(e) {
  // Skip modifier-key combos that are handled elsewhere
